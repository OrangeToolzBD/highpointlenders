// Highpoint Lenders - Austin metro neighborhood pages.
...
export const SUBURBS: Suburb[] = [
  {
    ...
    intro:
      "Downtown Austin runs from Lady Bird Lake north to the Texas State Capitol and concentrates the city's legal, financial, government and conference economy. Congress Avenue and the Second Street District anchor retail and dining; the warehouse district holds bar and music venues; and Class A office towers along Cesar Chavez, Sixth Street and Brazos house law firms, accounting practices, tech HQs and the financial advisors who serve them. Highpoint Lenders works with downtown operators to finance partner buy-ins, build-outs, condo office purchases and working capital sized to Capitol-corridor rent.",
  ...
  },
  {
    ...
    intro:
      "Round Rock sits north of Austin in Williamson County and anchors one of the metro's most established suburban submarkets. Dell Technologies' global headquarters drives a substantial corporate-services economy; the IKEA, Round Rock Premium Outlets and SH-130 retail corridors anchor consumer commerce; St. David's Round Rock and Baylor Scott & White Round Rock anchor healthcare; and a wide base of family-services, automotive, hospitality and light-industrial operators serve the residential population. Highpoint Lenders finances Round Rock operators with SBA acquisitions, real estate purchases, equipment financing for medical and dental, and working capital across retail and hospitality.",

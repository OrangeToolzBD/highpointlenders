...
>(({ className, ...props }, ref) => (
  <div className="pointer-events-none fixed inset-x-0 top-[calc(4rem+0.375rem)] z-50 flex justify-center px-4">
    <NavigationMenuPrimitive.Viewport
      className={cn(
        "origin-top pointer-events-auto relative h-[var(--radix-navigation-menu-viewport-height)] w-full max-w-[var(--radix-navigation-menu-viewport-width)] overflow-hidden rounded-md border bg-popover text-popover-foreground shadow data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-90",
        className,
      )}
      ref={ref}
      {...props}
